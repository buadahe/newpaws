...
/* ======================================================================
	...
	Plugin Name: Petfinder: Search & Rescue
	Plugin URI: http://www.lendingapaw.org/plugins/petfinder-search-rescue/
	Description: Petfinder: Search & Rescue offers a filterable and searchable list of all your animals that you have uploaded to your Petfinder account.  
	Version: 1.02
	Author: Stephanie Chow
	Author URI: http://www.lendingapaw.org
	License: GPLv2 or later

	Special Thanks to the following for helping me understand how to work with Petfinder's API:
	
	Bridget Wessel's Petfinder Listings Plugin
	http://wordpress.org/extend/plugins/petfinder-listings/
	
	Chris Ferdinandi Petfinder API for WP
...
Petfinder: Search & Rescue uses both Petfinder.com API as well as the Shuffle.js plugin v2.1.1 http://vestride.github.io/Shuffle/ By @Vestride.
*/
...
function pet_sr_admin_page() {
	add_options_page('Petfinder:Search & Rescue Settings', 'Petfinder: Seach & Rescue', 'manage_options', 'pet_sr', 'pet_sr_options_page');
}
...
//IF CHOSE SAVE CHANGES, STORE NEW VALUES
  ...
  <!--LOAD SPANS/ROWS STYLES FOR SETTINGS PAGE-->   
     <link rel="stylesheet" type="text/css" href="<?php echo plugins_url('css/psr_rows_styles.css', __FILE__ );?>">
...
<input type="checkbox" name="psr_optionssection_remove" <?php 
        ...
        <div class="psr__span12"><h2>Link to Adoption Form</h2></div>
              ...
              <div class="psr__row-fluid">
        		<div class="psr__span6">
        			<div class="psr_options_title"> Please type in the full link <br/><em> Example: http://www.mysite.com/adoption-form/</em></div>
