...
<div class="superboxed">

	<header>
		<h3 class="cat-color"><?php _e( 'Customer details', 'woocommerce' ); ?></h3>
	</header>
...
<div class="col2-set addresses">
	...
	<div class="col-1 superboxed">

<?php endif; ?>

		<header class="title">
			<h3 class="cat-color"><span><?php _e( 'Billing Address', 'woocommerce' ); ?></span></h3>
		</header>
		<address>
			<?php
...
<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
	...
	<div class="col-2 superboxed">

		<header class="title">
			<h3 class="cat-color"><span><?php _e( 'Shipping Address', 'woocommerce' ); ?></span></h3>
		</header>
		<address>
			<?php
