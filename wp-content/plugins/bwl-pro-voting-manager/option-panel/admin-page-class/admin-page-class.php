...
jQuery(this).append('<img src="' + jQuery(this).next().next().val() + '" style="height: 16px;width: 16px;" />');
...
*/
  public function show_field_text( $field, $meta) {
    $this->show_field_begin( $field, $meta );
    echo "<input type='text' class='at-text".(isset($field['class'])? " {$field['class']}": "")."' name='{$field['id']}' id='{$field['id']}' value='".stripslashes($meta)."' size='50' />"."\n";
    $this->show_field_end( $field, $meta );
  }
...
*/
  ...
  public function show_field_media_manager($field,$meta){
    ...
    $height = (isset($field['preview_height']))? $field['preview_height'] : '16px';
    $width = (isset($field['preview_width']))? $field['preview_width'] : '16px';
