...
add_filter ('bbp_has_replies', 'rw_djwd_bbp_has_replies') ;
add_filter ('bbp_has_topics', 'rw_djwd_bbp_has_topics') ;

function rw_djwd_bbp_has_replies( $args = '' ) {
	global $wp_rewrite;
...
function rw_djwd_bbp_has_topics( $args = '' ) {
	global $wp_rewrite;
...
//FIX to unset 's'
	...
	// Return object
	return apply_filters( 'rw_djwd_bbp_has_topics', $bbp->topic_query->have_posts(), $bbp->topic_query );
